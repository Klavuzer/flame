        ...
        if ($query) {
          ...
          if(isset($p2['status'])) {
           ...
           if ($can == 1) {
              ...
              $query_one = mysqli_query($con, "DROP TABLE fl_config");
              $query_one = mysqli_query($con, "DROP TABLE fl_users");
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo ($is_writable == true) ? '<font color="green"><i class="fa fa-check fa-fw"></i> Writable</font>' : '<font color="red"><i class="fa fa-times fa-fw"></i> Not writable</font>'?></td>
                                ...
                                <div class="req">
                                    <h5>FLAME successfully installed, if you have any qeastion, please let us <a href="mailto:phpflamesocial@gmail.com">know</a></h5>
                                    <br>
